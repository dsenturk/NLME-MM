...
##              single- and multi-level NLME models via MM algorithm.
###########################################################################################
## List of contents:
##    1. NlmeModel: A type that contains model components and placeholders for variables
##                  used in MM algorithm for single-level NLME model
...
##                   used in MM algorithm for multi-level NLME model
...
function NlmeModel_construct(
    ...
    #########################################################################################
    ## Description: Function that constructs object of type `NlmeModel` that contains trial-level
...
function MnlmeModel_construct(
    ...
    #########################################################################################
    ## Description: Function that constructs object of type `MnlmeModel` that contains trial-
    ##              level ERP responses, model components, and placeholders for variables used
    ##              in MM algorithm for multi-level NLME
    ## Definition:  T: number of trial time points
    ##              n: number of subjects
